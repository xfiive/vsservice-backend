...
public class ProductService {
    ...
    public Optional<Product> addProduct(@NotNull Product product) {
        if (product.getId() != null && productRepository.findById(product.getId()).isPresent()) {
            throw new ProductServiceException("Failed to add new product", "Such product already exists");
        }
    ...
    public Product updateProduct(Product product, String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to update product", "Product not found"));
    ...
    public Product updateProperties(List<String> properties, String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to update product properties", "Product not found"));
    ...
    public Product updateImage(String imageBase64, String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to update product image", "Product not found"));
    ...
    public Product updateName(String name, String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to update product name", "Product not found"));
    ...
    public Product updatePrice(BigDecimal price, String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to update product price", "Product not found"));
    ...
    public void deleteProduct(String id) {
        Product existingProduct = productRepository.findById(id)
                .orElseThrow(() -> new ProductServiceException("Failed to delete product", "Product not found"));
    ...
    public Product recoverProductServiceException(@NotNull ProductServiceException e, String id) {
    ...
    @Recover
    @SuppressWarnings("unused")
    public Product recoverFromGetProduct(@NotNull ProductServiceException e, String id) {
    ...
    @Recover
    @SuppressWarnings("unused")
    public Product recoverFromAddProduct(@NotNull ProductServiceException e, Product product) {
    ...
    @Recover
    @SuppressWarnings("unused")
    public Product recoverFromUpdateProduct(@NotNull ProductServiceException e, Product product, String id) {
